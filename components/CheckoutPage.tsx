  ...
  return (
    <section className="max-w-2xl mx-auto text-center animate-fade-in py-16">
      <div className="bg-gray-800/40 border border-gray-700 rounded-lg p-12 flex flex-col items-center">
        <CheckCircleIcon className="w-20 h-20 text-fuchsia-400 mb-6" />
        ...
        <button
          ...
          className="font-orbitron text-lg inline-flex items-center gap-3 bg-fuchsia-600 hover:bg-fuchsia-500 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-fuchsia-400 focus:ring-opacity-50 shadow-[0_0_20px_rgba(217,70,239,0.5)]"
        >
          Continue Shopping
        </button>
      </div>
